...
# All known table names in the schema (for hallucination detection)
ALL_KNOWN_TABLES = {
    "stg_events", "stg_users", "stg_devices", "stg_campaigns",
    "int_sessions", "int_event_sequences",
    "dim_users", "dim_campaigns",
    "fct_events", "fct_sessions", "fct_pageviews", "fct_conversions",
    "rpt_user_engagement", "rpt_funnel_analysis",
    # Raw sources
    "events", "users", "devices", "campaigns",
}
...
def evaluate_single(
    ...
    Args:
        test_case: Test case dict with expected values.
        generated_sql: The SQL string generated by the system.
        known_tables: Set of all valid table names in the schema.
    ...
    known = known_tables or ALL_KNOWN_TABLES
    ...
    hallucinated_tables = found_tables - known  # Tables that don't exist at all
    extra_tables = found_tables - expected_tables  # Real tables used unnecessarily
    missing_tables = expected_tables - found_tables  # Expected but not found
